...
Route::get('/',[App\Http\Controllers\Auth\LoginRegisterController::class,'login']);
...
Route::get('/transaction',[App\Http\Controllers\TransactionController::class,'create'])->name('transaction');
